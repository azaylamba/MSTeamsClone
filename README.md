...
You have to design & build the backend for the application and the ability for the users to register, post messages, join workspaces etc.
...
https://github.com/azaylamba/MSTeamsClone  
